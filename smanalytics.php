            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="dashboard-title">
                        <i class="bi bi-shield-check me-3"></i>Security Manager Analytics
                    </h1>
                    <p class="dashboard-subtitle">Real-time visitor monitoring and security insights</p>
                </div>
        ...
        <div class="time-filter">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <a href="cso_dashboard.php" class="btn btn-outline-primary me-2" style="color: #07AF8B !important; border-color: #07AF8B !important;"
