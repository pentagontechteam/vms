...
function isValidTableName($table) {
    ...
    $allowedTables = [
        'visitors', 'employees', 'receptionists', 'cso', 'daily_premises_entries',
        'visitor_categories', 'premises_entry_log', 'notifications', 'password_resets',
        'reception_notifications', 'daily_statistics', 'enhanced_entry_log'
    ];
