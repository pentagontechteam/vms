...
<head>
  ...
  <style>
    ...
    * {
    ...
    .scroll-box {
      max-height: 170px;
      /* Adjust depending on your row height */
      overflow-y: auto;
    }
      ...
      <div class="right-panel">
        ...
        <div class="stats">
          <div class="stat-card accent">
            <h1><?= $stats['total_requests'] ?? 0 ?></h1>
            <p>Requests</p>
          </div>
          <div class="stat-card green">
            <h1><?php echo $stats['approved']; ?></h1>
            <p>Approved</p>
          </div>
          <div class="stat-card gray">
            <h1><?php echo $stats['declined']; ?></h1>
            <p>Declined</p>
          </div>
        </div>
     ...
     : 'Pending'}
      ...
      function formatTime(timestamp) {
        ...
        return date.toLocaleTimeString('en-US', {
          ...
          '<br>' + date.toLocaleDateString('en-US', {
            day: '2-digit',
            month: '2-digit',
            year: 'numeric'
          });
