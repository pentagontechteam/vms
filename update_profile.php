...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['new_password'])) {
        ...
        } elseif (!preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*#?&^()_+\-=])[A-Za-z\d@$!%*#?&^()_+\-=]{8,}$/', $new_password_raw)) {
...
<head>
  ...
  <title>Complete Your Profile | Visitor Management System</title>
...
<body>
  <div class="profile-container">
    ...
    <p style="text-align: center; margin-bottom: 1.5rem; color: #666;">Setup Your Profile</p>
  ...
  <div style="display: flex; gap: 0.5rem;">
    <select id="country_code" name="country_code" required style="padding: 0.75rem; border-radius: 8px; border: 1px solid #ddd;">
...
<option value="+263">🇿🇼 Zimbabwe (+263)</option>
    ...
    <input type="tel" id="phone" name="phone" pattern="^[0-9]{6,15}$" title="Enter a valid phone number (6-15 digits)" value="<?= htmlspecialchars($user['phone'] ?? '') ?>" required style="flex: 1;">
  </div>
</div>
